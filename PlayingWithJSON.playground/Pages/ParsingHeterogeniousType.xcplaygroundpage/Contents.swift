//Parsing Heterogenious type(mixed types)

// ex: postcode can me Int or String
// this will lead to decoding error
...
enum AppError: Error {
    case missingValue // if not an Int or string , throw error
}

// create custom object to be the data type of postcode
enum Postcode: Decodable {
    
    
    // handle 2 cases: Int and String
    // will use assosciated values to capture the value
    case int(Int)
    case string(String)
    // have to write decoder initializer
    init(from decoder: Decoder) throws {
        // handle two cases
        // if its not an int or string, we will throw error
        ...
        throw AppError.missingValue // was not Int or String
    }
}

// ecoding JSON to swift
